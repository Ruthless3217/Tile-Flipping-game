...
export function buildTiles() {
    const pairs = ICONS.flatMap((icon) => [
        { id: `${icon.id}-a`, iconId: icon.id, emoji: icon.emoji, label: icon.label, isFlipped: false, isMatched: false },
        { id: `${icon.id}-b`, iconId: icon.id, emoji: icon.emoji, label: icon.label, isFlipped: false, isMatched: false },
    ]);
